        ...
        try
        {
            if(timeText!=null && context!=null)
            {
                ...
                if(lastLightChar>0)
                {
                    ...
                    if(lastLightChar>0) {
                        if(lightTheme && mTapLightStart ==null ) mTapLightStart = new TextAppearanceSpan(context, R.style.TimeTextLight);
                        else if(!lightTheme && mTapDarkStart ==null) mTapDarkStart = new TextAppearanceSpan(context,R.style.TimeTextDarkThemeDark);
                    ...
                    if(lastLightChar<textLength) {
                        if(lightTheme && mTapLightEnd ==null ) mTapLightEnd = new TextAppearanceSpan(context, R.style.TimeTextDark);
                        else if(!lightTheme && mTapDarkEnd ==null) mTapDarkEnd = new TextAppearanceSpan(context,R.style.TimeTextDarkThemeLight);
